...
//   }),
// );
let ref_transporter = nodemailer.createTransport({
  service: "Gmail",
  secure: false,
...
let create_ref_mail_options = (userInfo) => {
  return (mailOptions = {
    from: process.env.mail,
    // from:"michelleannschlloser@outlook.com",
    to: userInfo.reciever,
    subject: `SOMEONE JUST REGISTERD WITH YOUR REFERRAL LINK`,
...
font-family: 'Roboto', sans-serif;
    ...
    <div class="head-txt">
      ...
      <h5 style="font-size: 15px;"> SOMEONE JUST REGISTERD WITH YOUR REFERRAL LINK </h5>
    </div>

    <p class="sm-p">
      Dear ${userInfo.first_name} ${userInfo.last_name}, someone just registerd using your referral link on <b>${datetime}</b>.

    </p>
    <p class="sm-p">
     You will receive a 10% referral bonus when they fund their account.
    </p>
    <p class="sm-p">
    NB:
...
module.exports = { ref_transporter,create_ref_mail_options };
